"""
Te con rosca macho NPT en línea (TMT) Swagelok con bloque central de forja.
Ver guía en guide/09-tes/macho-recta-tmt.md.
"""
...
@activate(
    Group="Tees",
    TooltipShort="Te macho en línea TMT",
    TooltipLong="Te con salida recta rosca macho NPT y ramal a 90 grados tubo",
    LengthUnit="in",
    Ports="3"
)
...
def MALE_RUN_TEE(s, OD=0.5, L=1.8, H=0.9, E=0.17, **kw):
    R = OD / 2
