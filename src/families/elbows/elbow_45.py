"""
Codo de 45 grados Swagelok.
Ver guía en guide/08-codos-45/index.md.
"""
...
@activate(
    Group="Elbows",
    TooltipShort="Codo a 45 grados",
    TooltipLong="Conecta dos tubos en un ángulo de 45 grados",
    LengthUnit="in",
    Ports="2"
)
...
def SIMPLE_ELBOW_45(s, OD=1.0, L=2.0, T=0.1, **kw):
    R1 = float(L)
    R2 = float(OD) / 2.0
    if R1 <= R2:
        R1 = R2 + 0.0001
