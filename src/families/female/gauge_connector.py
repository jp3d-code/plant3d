"""
Conector hembra para manómetros ISO/BSP RG Swagelok.
Ver guía en guide/03-conectores-hembra/iso-bsp-rg-manometros.md.
"""
...
@activate(
    ...
    TooltipShort="Conector manómetro",
    TooltipLong="Conector hembra para manómetros ISO/BSP paralela (cierre por junta plana)",
    LengthUnit="in",
    Ports="2"
)
...
def GAUGE_CONNECTOR(s, A=1.60, D=0.60, E=0.19, F=0.875, **kw):
    Rbody = D / 2
    Rhex = F / 2
    Rbore = E / 2
    halfA = A / 2
