"""
Te con rosca macho NPT en el ramal (TTM) Swagelok con bloque central de forja.
Ver guía en guide/09-tes/macho-lateral-ttm.md.
"""
...
@activate(
    Group="Tees",
    TooltipShort="Te macho en ramal TTM",
    TooltipLong="Te con paso recto tubo-tubo y ramal a 90 grados rosca macho NPT",
    LengthUnit="in",
    Ports="3"
)
...
@param(H=LENGTH, TooltipShort="Altura de la derivación macho")
@param(E=LENGTH, TooltipShort="Diámetro de paso mínimo interior")
def MALE_BRANCH_TEE(s, OD=0.5, L=1.8, H=0.9, E=0.17, **kw):
    R = OD / 2
